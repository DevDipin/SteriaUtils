...
public class CommandFramework implements CommandExecutor {
            ...
            if (commandMap.containsKey(cmdLabel)) {
                ...
                if (!command.permission().equals("")) {
                    ...
                    if (!sender.hasPermission(command.permission())) {
                        sender.sendMessage(Color.translate("&3&lSteria &7| &cYou do not have permissions to execute this command."));
                        return true;
                    }
                }
                if (command.inGameOnly() && !(sender instanceof Player)) {
                    sender.sendMessage(Color.translate("&3&lSteria &7| &cConsole cannot execute this command."));
                    return true;
                }
                try {
    ...
    private void defaultCommand(CommandArgs args) {
        args.getSender().sendMessage(Color.translate("&3&lSteria &7| &cSorry, you cannot use this command."));
    }
